      ...
      >
        <FadeIn className="z-50 flex items-center justify-center w-full ">
          <div className="absolute min-w-[614px] min-h-[614px]">
            <Image
              alt="Turbopack"
              src="/pack/pack-hero-hexagons-dark.svg"
              width={614}
              height={614}
            ...
            <Image
              alt="Turbopack"
              src="/pack/pack-hero-hexagons-light.svg"
              width={614}
              height={614}
          ...
          <div className="w-[120px] h-[120px] z-50">
            <Image
              alt=""
              src="/pack/pack-hero-logo-dark.svg"
              width={120}
              height={120}
              className="hidden dark:block"
            />
            <Image
              alt=""
              src="/pack/pack-hero-logo-light.svg"
              width={120}
              height={120}
              className="block dark:hidden"
            />
        ...
        >
          <h1 className="text-5xl uppercase font-bold mb-4">TURBOPACK</h1>
          <h2 className="text-3xl font-semibold">The Rust-powered successor to Webpack</h2>
          <p className="text-xl">
